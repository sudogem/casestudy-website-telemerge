...
class httpupload {
	...
	var $error_lang = array(
			HTTPUPLOAD_ERROR_NO_FILE => "No file was submitted.",
			...
			HTTPUPLOAD_ERROR_SIZE => "The uploaded file exceeds the maximum file size directive that was specified in class setting.",
	...
	function processfile($b , $t , $mod , $overWrite = false) {
		...
		//if ( !move_uploaded_file($p2 , $p ) ) return false;
