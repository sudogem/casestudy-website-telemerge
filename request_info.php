...
<div id= "container" >
  ...
  <ul id="nav" >
    ...
    <li><a href="request_info.php" id="cmdrequest" class="cmddefault">Request Info</a></li>
  </ul>
  <!-- InstanceEndEditable -->
  <div class="clear" ></div>
  <!-- InstanceBeginEditable name="front-content" -->
<div id= "column" >
<form method="post" action="sendrequest.php" name="emailForm"  >
      <div class="contact_email">
      <h1 class="cap2 capline" >Request Information</h1>
<p class="cap1">Looking for more information? You can fill up the request form below and feel free to ask a questions regarding our services. You can email us at <a href="mailto:support@telemerge.com" >support@telemerge.com</a></p>	  
